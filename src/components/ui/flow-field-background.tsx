...
export default function NeuralBackground({
  ...
  // NOTE: This project does not ship Tailwind, so the layout is applied via
  // inline styles. The original Tailwind utility classes are preserved through
  // `cn(...)` so the component keeps working as-is if Tailwind is added later.
  return (
    <div
      ref={containerRef}
